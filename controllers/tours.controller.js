const { getAllToursService, addTourService, getTourByIdService, updateTourByIdService, getTopThreeTrendingTourService } = require("../services/tours.service")
...
exports.getTopThreeTrendingTour = async(req, res, next) => {
    try{
